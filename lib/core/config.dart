abstract final class AppConfig {
  ...
  static const streamingCatalogsManifestUrl = String.fromEnvironment(
    ...
    defaultValue: 'https://7a82163c306e-stremio-netflix-catalog-addon.baby-beamup.club/manifest.json',
  );
  ...
  static const streamingCatalogsEnabled = bool.fromEnvironment('STREAMING_CATALOGS_ENABLED', defaultValue: true);

  static bool get hasStreamingCatalogs => streamingCatalogsEnabled && streamingCatalogsManifestUrl.trim().isNotEmpty;
}
