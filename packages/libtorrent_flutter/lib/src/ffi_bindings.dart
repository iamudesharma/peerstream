...
DynamicLibrary _openNativeLib() {
  ...
  if (Platform.isWindows) {
    ...
    // Source builds are linked into the CocoaPods framework. The previous
    // prebuilt package shipped a standalone dylib, so loading by the old name
    // fails after switching to a reproducible source build.
    final executable = File(Platform.resolvedExecutable);
    final framework =
        '${executable.parent.parent.path}/Frameworks/$libName.framework/$libName';
